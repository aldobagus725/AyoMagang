<html>
    ...
    <body>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-sm-6 text-left wow fadeInLeft">
                                               <img src="assets/img/logo/logo%20ayo%20magang%20putih.png" width="80%;">
                                            </div>
                                    ...
                                    <div class="card-body text-right">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <h6 style="font-size:22px;padding-bottom:40px;color:white;line-height:1.5;">
                                                ...
                                                <a href="company/login.php" class="btn btn-success">Posting Magang</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container-fluid" id="collaboration">
            <div class="row"><div class="col"><h2 class="text-center" style="padding-top:30px">Partner Kami</h2></div></div>
            <div class="container">
                <hr>
                <div class="row align-items-center text-center" style="padding-top:40px;">
                    <div class="col"><img src="assets/img/partner/stikom.png" width="50%"></div>
                    <div class="col"><img src="assets/img/partner/help.png" width="75%"></div>
                </div>
            </div>
        </div>
        <div class="container-fluid" id="about">
            <div class="row"><div class="col"><h1 class="text-center" style="padding-top:50px">Tentang Kami</h1></div></div>
            <div class="container">
                <hr>
                <div class="row align-items-center" style="padding-top:50px;">
                    <div class="col"><img src="assets/img/carousel/2.jpg" width="100%" class="rounded shadow"></div>
                    <div class="col">
