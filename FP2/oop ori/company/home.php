				...
				<div class="about-us-box-text">
					<center>
						...
						<table class="table table-borderless table-hover table-dark">
							...
							$query = $company->view_lowongan($id);
						...
						<div class="testimonial-text">
							<center>
								<table class="table table-dark table-hover">
									<tr>
										<th>ID Perusahaan</th>
										<td><?php echo $_SESSION['company']['company_id']; ?></td>
									</tr>
									<tr>
										<th>Nama Perusahaan</th>
										<td><?php echo $_SESSION['company']['company_name']; ?></td>
									</tr>
									<tr>
										<th>Username</th>
									...
									<tr>
										<th>SIUP</th>
										<td><?php echo $_SESSION['company']['siup']; ?></td>
									</tr>
									<tr>
										<th>Alamat</th>
									...
									<tr>
										<th>Email</th>
										<td><?php echo $_SESSION['company']['email']; ?></td>
									</tr>
									<tr>
										<th>Telepon</th>
										<td><?php echo $_SESSION['company']['phone']; ?></td>
									</tr>
								</table>
							</center>
						</div>
