...
<html>
                    ...
                    <div class="col-sm-6 wow fadeInRight justify-content-end">
                        <div class="card rounded border-0" style="background-color:rgba(255,255,255,0);">
                            <div class="card-body" style="color:white;">
                                <p style="color:white;font-weight:276;font-size:26px;">Student Register</p>
                                <form method="post" id="register-student-form" onSubmit="return valid();">
                                <div class="form-group">
                                    <label for="fullname">Nama Lengkap:</label>
                                    <input type="text" name="fullname" class="form-control" required autofocous> 
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col text-right">
                                            <input type="submit" name="register-student" class="btn btn-primary btn-block" id="submit" value="Daftar jadi Student!"><br>
                                        </div>
                                    </div>
                                    <div class="row text-center">
                                        <div class="col">
                                            <a href="login.php"><button type="button" class="btn btn-success">Login ke Student</button></a>
                                            <a href="../company/register.php"><button type="button" class="btn btn-info">Daftar Jadi Company</button></a>    
                                        </div>
                                    </div>
                                </div>
                                </form>
    ...
    <?php
        if(isset($_POST['register-student'])){
            ...
            $reg_student = $student->register_student_first($fullname,$username,$password,$email,$token,$aktif);           
            if ($reg_student==1){include("regisMail.php");echo "<script>alert('Pendaftaran anda berhasil, silahkan cek email anda untuk aktivasi.');location = 'login.php';</script>";}
