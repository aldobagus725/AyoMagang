	...
	<body>
	    ...
	    <div class="card shadow mb-4">
	        <div class="card-header py-3">
                <div class="row">
                    <div class="col-sm-3">
                        <h3 class="m-0 font-weight-bold text-primary">Daftar Lowongan</h3>
                    </div>
                    <div class="col-sm-3">
                        <a href="home.php"><button class="btn btn-danger">Kembali</button></a>
                    </div>
                </div>
	        </div>
	        <div class="card-body">
	                ...
	                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
	                    ...
	                    <tbody>
							...
							<tr>
								...
								<td>
									<a href="appdetail.php?&id=<?php echo $dataapp['vacancies_id']; ?>" class="btn btn-primary btn-sm"> Detail</a>
								</td>
							</tr>
							<?php
								$nomor++;
