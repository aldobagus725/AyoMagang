 $(document).ready(function(){
    ...
    function update_last_activity(){
        $.ajax({
            url:"update_last_activity.php",success:function(){}
        })
    }
    ...
    function fetch_user_chat_history(to_user_id){
        $.ajax({
            ...
            method:"POST",data:{to_user_id:to_user_id},
            success:function(data){
                $('#chat_history_'+to_user_id).html(data);
            }
        })
    ...
    $(document).on('focus', '.chat_message', function(){
        ...
        $.ajax({
            ...
            method:"POST",data:{is_type:is_type},
            success:function(){}
        })
    });
    ...
    $(document).on('click', '.remove_chat', function(){
        ...
        if(confirm("Apa kamu yakin akan menghapus chat ini?")){
            $.ajax({
                ...
                success:function(data){update_chat_history_data();}
            })
        }
    });
});  