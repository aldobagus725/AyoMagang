        ...
        <div class="container-fluid" id="collaboration">
            ...
            <div class="container">
                ...
                <div class="row align-items-center text-center" style="padding-top:40px;">
                    <div class="col">
                        <img src="assets/img/partner/stikom.png" width="50%">
                    </div>
                    <div class="col">
                        <img src="assets/img/partner/help.png" width="75%">
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid" id="about">
            ...
            <div class="container">
                ...
                <div class="row align-items-center" style="padding-top:50px;">
                    <div class="col">
                        <img src="assets/img/carousel/2.jpg" width="100%" class="rounded shadow">
                    </div>
                    <div class="col">
