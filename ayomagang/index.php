...
<!--
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#services">Info Magang</a>
			            </li>
-->
			            <li class="nav-item">
			            ...
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#portfolio">Tentang</a>
			            </li>
			            <li class="nav-item">
			                <a class="nav-link scroll-link" href="#testimonials">Footer</a>
			            </li>
			            <li class="nav-item">
...
<!--                        <h1 class="wow fadeInLeftBig">Ayo Magang: Getting Academic Internship Easier</h1>-->
                        <h1 class="wow fadeInLeftBig">Mencari Magang Akademik Menjadi Lebih Mudah!</h1>
                        <div class="description wow fadeInLeftBig">
<!--                        	<p>Helps you out to get the desired internship for your academic needs!</p>-->
                            <p>Membantu kamu mencari magang akademik sesuai kebutuhanmu!</p>
                        </div>
...
<!--
                        <div class="top-big-link wow fadeInUp">
                        	<input class="form-control mr-sm-2" type="text" placeholder="Course name, field of study, i.e. Information System">
                            <br/>
...
-->
        ...
        <div class="blog-container section-container">
	        <div class="container">
	            ...
	            <div class="row">
	            	<div class="col section-bottom-button wow fadeInUp">
                        <a class="btn btn-primary btn-link-3" href="#">Visit the blog</a>
	            	</div>
	            </div>
