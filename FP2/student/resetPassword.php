<?php
    ...
    if(mysqli_num_rows($getEmailQuery) == 0){exit("Error 404! CANNOT FIND PAGE");}
    if(isset($_POST["submit"])){
        ...
        if($resetPwd == 1){echo "<script>alert('Password berhasil direset! Silakan login ulang!');location='login.php';</script>";}
        else{echo '<script><div class="alert alert-danger">Something Went Wrong!</div></script>';}
    }
?>
<html>
    <head>
