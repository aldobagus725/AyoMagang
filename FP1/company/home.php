            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 offset-md-2 text">
                        <h1 class="wow fadeInLeftBig">Halo <?php echo $_SESSION['company']['company_name']; ?>!</h1>
                        <div class="description wow fadeInLeftBig">
                            <p>langsung Buka Lowongan Magang Akademik Anda!</p>
                        </div>
                        <div class="top-big-link wow fadeInUp">
                            <a href="buka-lowongan.php"><button class="btn btn-success" type="submit">Buka Lowongan</button></a>
                        </div>
                    </div>
                </div>
            </div>            
                ...
                <div class="row">
	            	<div class="col about-us-box wow fadeInLeft">
	                    <div class="about-us-box-text">
                            <center>
                                <h1>Daftar Bukaan Lowongan Anda</h1>
                                <hr>
                                ...
                                <tr>
                                    ...
                                    <td><a href="detail-lowongan.php?&id=<?php echo $data['vacancies_id']; ?>" class="btn btn-primary btn-sm"> Detail</a></td>
                                </tr>
                                    <?php }} ?>
                            </table>
                            </center>
        	...
        	<div class="container">
        		<div class="row">
        			<div class="col testimonials section-description wow fadeIn">
                        <h2 style="color: white;">Profil Perusahaan</h2>
                    </div>
        		</div>
        		<div class="row">
                				...
                				<div class="testimonial-text">
                                    <center>
                                     <table class="table table-dark table-hover">
                                        <tr>
                                            <th>ID Perusahaan</th><td><?php echo $_SESSION['company']['company_id']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Nama Perusahaan</th><td><?php echo $_SESSION['company']['company_name']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>Username</th><td><?php echo $_SESSION['company']['username']; ?></td>
                                        </tr>
                                        <tr>
                                            <th>SIUP</th><td><?php echo $_SESSION['company']['siup']; ?></td>
                                        </tr>
                                        <tr>
