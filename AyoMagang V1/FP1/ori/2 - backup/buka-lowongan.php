<?php
	...
	$query = $koneksi->query("SELECT * FROM company WHERE id_perusahaan = '$_GET[id]'");
					...
					<div class="card">
						...
						<div class="card-body">
							<form method="POST" class="form-horizontal">
								...
								<div class="form-group">
									<input type="hidden" class="form-control" name="idperusahaan" required="" value="<?php echo $_SESSION['company']['id_perusahaan']; ?>" readonly>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="bidang" required="" value="">
								</div>
								<div class="form-group">
									<label class="control-label">Syarat Magang</label>
									<textarea class="form-control" name="syarat" rows="2" required="" value=""></textarea>		
								</div>
								<div class="form-group">
							...
							<?php
								if(isset($_POST['buat'])){
									...
									$bidang   = $_POST['bidang'];
									$syarat   = $_POST['syarat'];	
										$koneksi->query("INSERT INTO open_app (id_perusahaan,
																				nama_perusahaan,
																				author,
									                                            alamat_perusahaan,
									                                            telepon,
