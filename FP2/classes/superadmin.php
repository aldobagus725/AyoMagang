...
class superadmin{
    ...
    public function addAdmin($fullname,$username,$password,$email){
        $this->fullname = $fullname;
        $this->username = $username;
        $this->password = $password;
        $this->email = $email;
        if(mysqli_query($this->con, "insert into superadmin (fullname,username,password,email) values ('$fullname','$username','$password','$email')")){return 1;}
        else{return 2;}
    }
    //Views
