...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-no-bg">
    <div class="container">
        <?php if(isset($_SESSION['student'])) {?><a class="navbar-brand" href="dashboard.php"><img src="../assets/img/logo/logo%20putih.png"></a>
        <?php }else if(isset($_SESSION['company'])){?><a class="navbar-brand" href="dashboard.php"><img src="../assets/img/logo/logo%20putih.png"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link scroll-link" href="#footer">Kontak</a></li>
                <li class="nav-item"><a class="nav-link scroll-link" href="student/login.php">Login</a></li>
                <li class="nav-item"><a class="nav-link scroll-link" href="company/login.php">Posting Magang</a></li>
                <?php }?>              
            </ul>
        </div>
    </div>
